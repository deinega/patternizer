...
${OBJECTDIR}/_ext/52a4beb5/quandl.o: ../../../src/quandl.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../include -I../../../../rapidjson/include `pkg-config --cflags libcurl`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/quandl.o ../../../src/quandl.cpp

${OBJECTDIR}/_ext/52a4beb5/web.o: ../../../src/web.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../include -I../../../../rapidjson/include `pkg-config --cflags libcurl`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/web.o ../../../src/web.cpp

${OBJECTDIR}/_ext/567886b7/test.o: /home/alex/kalich/applications/test/test.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/567886b7
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../include -I../../../../rapidjson/include `pkg-config --cflags libcurl`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/567886b7/test.o /home/alex/kalich/applications/test/test.cpp
